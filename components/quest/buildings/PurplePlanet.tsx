...
/**
 * Фиолетово-космическая планета с кольцами
 * 
 * Декоративный элемент - планета в фиолетово-космических тонах с кольцами
 * Основана на структуре Сатурна, но с фиолетовой цветовой палитрой
 */
export default function PurplePlanet({
  ...
  // Фиолетово-космические цвета
  const planetColor = new THREE.Color(0x9d4edd); // Фиолетово-пурпурный
  const ringColor = new THREE.Color(0x7b2cbf); // Темно-фиолетовый для колец
  const glowColor = new THREE.Color(0xbb86fc); // Светло-фиолетовое свечение
  ...
  return (
    ...
    >
      ...
      {/* Полосы на планете - неоновые фиолетовые цвета прямо на поверхности планеты */}
      {Array.from({ length: 9 }).map((_, i) => {
        ...
        // Неоновые фиолетово-космические цвета для полос
        const colors = [
          0xbb86fc, // Светло-фиолетовый
          0x9d4edd, // Фиолетово-пурпурный
          0xc77dff, // Яркий фиолетовый
          0xbb86fc, // Светло-фиолетовый
          0x9d4edd, // Фиолетово-пурпурный (центральный)
          0xc77dff, // Яркий фиолетовый
          0xbb86fc, // Светло-фиолетовый
          0x9d4edd, // Фиолетово-пурпурный
          0xc77dff, // Яркий фиолетовый
      ...
      <group ref={ringsRef} renderOrder={1}>
        ...
        {Array.from({ length: 8 }).map((_, ringIndex) => {
          ...
          // Разные оттенки фиолетово-космического цвета
          const colorVariations = [
            0x7b2cbf, // Темно-фиолетовый
            0x9d4edd, // Фиолетово-пурпурный
            0xbb86fc, // Светло-фиолетовый
            0xc77dff, // Яркий фиолетовый
            0x7b2cbf, // Темно-фиолетовый
